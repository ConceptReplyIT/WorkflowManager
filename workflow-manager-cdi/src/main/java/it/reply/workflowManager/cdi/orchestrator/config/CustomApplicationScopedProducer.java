...
@ApplicationScoped
/**
 * Used to configure jBPM Environment (persistence config, loading BPMN assets, binding WIH, ecc.)
...
public class CustomApplicationScopedProducer {
  ...
  public void disposeEnvironment(
      @Disposes @Singleton @PerProcessInstance @PerRequest RuntimeEnvironment re) {
    re.close();
  }

package it.reply.workflowManager.orchestrator.annotations;
...
/**
 * Binds EJBCommands' methods to {@link ManageEntitiesInterceptor} which finds 
 * all the entities contained inside the parameters of the intercepted method.
 * The EntityClasses parameter accepts an array of {@link Class}, containing the top-level 
 * Entities classes to which limit the Entity research.
 * The {@link Policy} parameter, specifies what action should be done to the found entities:
 * <ul>

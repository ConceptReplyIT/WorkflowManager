package it.reply.workflowmanager.exceptions;

public class WorkflowException extends RuntimeException {

  private static final long serialVersionUID = -2874917251800576516L;

  /**
   * Constructs a new workflow exception with {@code null} as its detail message. The cause is not
  ...
  /**
   * Constructs a new workflow exception with the specified detail message. The cause is not
   * initialized, and may subsequently be initialized by a call to {@link #initCause}.
   *
   * @param message
  ...
  /**
   * Constructs a new workflow exception with the specified cause and a detail message of
  ...
  /**
   * Constructs a new workflow exception with the specified detail message, cause, suppression
